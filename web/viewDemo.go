...
GridLayout {
	...
	content = [
		GridLayout {
			...
			content = [
				View { 
					id = dView, width = 250px, height = 150px,
...
func viewDemo(session rui.Session) rui.View {
	...
	rui.Set(view, "viewBorderStyle", rui.DropDownEvent, func(_ rui.DropDownList, number int) {
		if number < 5 {
			rui.Set(view, "dView", rui.BorderStyle, number)
		} else {
			rui.Set(view, "dView", rui.BorderTopStyle, 1)
			rui.Set(view, "dView", rui.BorderRightStyle, 2)
			rui.Set(view, "dView", rui.BorderBottomStyle, 3)
			rui.Set(view, "dView", rui.BorderLeftStyle, 4)
		}
	})
	...
	rui.Set(view, "viewBorderWidth", rui.DropDownEvent, func(_ rui.DropDownList, number int) {
		...
		if number < len(widths) {
			rui.Set(view, "dView", rui.BorderWidth, widths[number])
		} else {
			rui.SetParams(view, "dView", rui.Params{
	...
	rui.Set(view, "viewBorderColor", rui.DropDownEvent, func(_ rui.DropDownList, number int) {
		...
		if number < len(colors) {
			rui.Set(view, "dView", rui.BorderColor, colors[number])
		} else {
			rui.SetParams(view, "dView", rui.Params{
	...
	rui.Set(view, "viewRadius", rui.DropDownEvent, func(_ rui.DropDownList, number int) {
		switch number {
		case 0:
			rui.Set(view, "dView", rui.Radius, nil)

		case 1:
			rui.Set(view, "dView", rui.Radius, rui.Px(8))

		case 2:
			rui.Set(view, "dView", rui.RadiusX, rui.Px(12))
			rui.Set(view, "dView", rui.RadiusY, rui.Px(24))

		case 3:
			rui.Set(view, "dView", rui.Radius, nil)
			rui.Set(view, "dView", rui.RadiusTopRightX, rui.Px(48))
			rui.Set(view, "dView", rui.RadiusTopRightY, rui.Px(24))
			rui.Set(view, "dView", rui.RadiusBottomLeftX, rui.Px(48))
			rui.Set(view, "dView", rui.RadiusBottomLeftY, rui.Px(24))
		}
	})
